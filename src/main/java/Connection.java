...
class Connection implements Runnable {
     ...
     * @param socket   The underlying socket connection.
     * @param listener A connection listener (required).
     */
     ...
     *
     * @throws IllegalStateException If the connection routine has already been started.
     */
     ...
     *
     * @throws IllegalStateException If the connection routine is not started.
     */
